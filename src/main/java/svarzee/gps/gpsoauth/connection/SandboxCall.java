...
public class SandboxCall implements Call {
	Request request;

	SandboxCall(Request request) {
	...
	public Response execute() throws IOException {
		...
		Response response = new Response.Builder().code(connection.getResponseCode())
				.message(connection.getResponseMessage()).request(request).protocol(Protocol.HTTP_1_1)
